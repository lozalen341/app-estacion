...
<div style="max-width: 600px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, sans-serif; background: #ffffff;">
    ...
    <div style="padding: 2.5rem 2rem;">
        <h2 style="margin: 0 0 1.25rem 0; color: #1e293b; font-size: 1.5rem; font-weight: 400;">Bienvenido/a de nuevo a ClimaLink</h2>
        <p style="margin: 0 0 1.5rem 0; color: #475569; font-size: 1rem; line-height: 1.6;">Se inició sesión en tu cuenta con los siguientes detalles:</p>
